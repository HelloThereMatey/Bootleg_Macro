...
from bootleg_datafeed.dataset import Dataset, SOURCES
...
class WatchlistSearch:
    ...
    Wraps each source's existing search_* function from bootleg_datafeed.sources,
    ...
    def _search_fred(self, query: str, **kwargs) -> pd.DataFrame:
        from bootleg_datafeed.sources.fred_source import search_fred
    ...
    def _search_nasdaq(self, query: str, **kwargs) -> pd.DataFrame:
        from bootleg_datafeed.sources.nasdaq_source import search_nasdaq
    ...
    def _search_glassnode(self, query: str, **kwargs) -> pd.DataFrame:
        from bootleg_datafeed.sources.glassnode_source import search_glassnode_metrics
    ...
    def _search_tedata(self, query: str, **kwargs) -> pd.DataFrame:
        from bootleg_datafeed.sources.tedata_source import search_tedata
    ...
    def _search_cryptocompare(self, query: str, **kwargs) -> pd.DataFrame:
        from bootleg_datafeed.sources.cryptocompare_source import search_cryptocompare
