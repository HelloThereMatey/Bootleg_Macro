...
from bootleg_macro.watchlist_gui.gui._models import PandasModel, SearchWorker, WatchlistSelectionModel
from bootleg_macro.watchlist_gui.gui._logging import log
from bootleg_macro.watchlist_gui.gui.widgets import ResultsTable, SearchBar, WatchlistPanel
...
def launch() -> WatchlistBuilderWindow:
    ...
    any Python environment (scripts, notebooks, REPL):
        ...
        from bootleg_macro.watchlist_gui.gui import launch
        window = launch()
    """
