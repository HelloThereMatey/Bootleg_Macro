...
from bm import Dataset, SOURCES, Watchlist, WatchlistSearch
from bm.gui._models import PandasModel, SearchWorker, WatchlistSelectionModel
from bm.gui._logging import log
from bm.gui.widgets import ResultsTable, SearchBar, WatchlistPanel
...
class WatchlistBuilderWindow(QtWidgets.QMainWindow):
    ...
    def _on_series_double_clicked(self, row_dict: dict):
        ...
        from bm.models import SeriesMetadata, StandardSeries
